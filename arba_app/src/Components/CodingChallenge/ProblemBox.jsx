...
function ProblemBox() {
    return (
        <Box m={"auto"} padding={{ base: 4, sm: 14, md: 14, lg: 8, xl: 10 }} >
            <Box w={"90%"} textAlign={"left"} fontSize={20} fontWeight={700}  border={"1px solid red"} m={"auto"}>
                <Text>Code Challenge</Text>
            </Box>
            <Box border={"1px solid red"} w={"90%"} m={"auto"} pt={20} pb={20} bgColor={"rgb(44, 203, 203)"} color={"white"} fontWeight={600} >
